...
var translations = {
  en: {
    ...
    favaOptions: "Fava options",
    beancountOptions: "Beancount options",
    system: "System",
    dark: "Dark",
    light: "Light",
    optionKey: "Key",
    ...
    noEvents: "No events.",
    postingsPerAccount: "Postings per Account",
    entriesPerType: "Entries per Type",
    type: "Type",
    ...
    moveDocument: "Move or rename document",
    move: "Move",
    previewNotImplemented: "Preview for file `%(filename)s` with file type `%(extension)s` is not implemented",
    price: "Price",
    noPrices: "No prices.",
    file: "File",
    line: "Line",
    ...
    updateActivityLastEntry: "Last Entry",
    treemap: "Treemap",
    icicle: "Icicle",
    sunburst: "Sunburst",
    export: "Export",
  ...
  "zh-CN": {
    ...
    description: "\u63CF\u8FF0",
    noEvents: "\u6CA1\u6709\u4E8B\u4EF6\u3002",
    postingsPerAccount: "\u6BCF\u8D26\u6237\u5206\u5F55\u6570",
    entriesPerType: "\u6309\u7C7B\u578B\u6761\u76EE\u6570",
    type: "\u7C7B\u578B",
    entriesCount: "\u6761\u76EE\u6570",
    total: "\u5408\u8BA1",
    account: "\u8D26\u6237",
    name: "\u540D\u79F0",
    noDocuments: "\u6CA1\u6709\u6587\u6863\u3002",
    moveDocument: "\u79FB\u52A8\u6216\u91CD\u547D\u540D\u6587\u6863",
    move: "\u79FB\u52A8",
    previewNotImplemented: "\u6682\u4E0D\u652F\u6301\u9884\u89C8\u6587\u4EF6 `%(filename)s`\uFF08\u7C7B\u578B `%(extension)s`\uFF09",
    price: "\u4EF7\u683C",
    noPrices: "\u6CA1\u6709\u4EF7\u683C\u3002",
    file: "\u6587\u4EF6",
    line: "\u884C",
...
// src/fava/components/AutocompleteInput.svelte
var root_12 = template(`<button type="button" class="muted round svelte-qkidfo">\xD7</button>`);
var root_6 = template(`<span class="svelte-qkidfo"> </span>`);
var root_3 = template(`<li role="option" class="svelte-qkidfo"></li>`);
var root_2 = template(`<ul role="listbox" class="svelte-qkidfo"></ul>`);
var root = template(`<span class="svelte-qkidfo"><input type="text" autocomplete="off" role="combobox" class="svelte-qkidfo"> <!> <!></span>`);
function AutocompleteInput($$anchor, $$props) {
  push($$props, false);
  const size = mutable_state();
  const extractedValue = mutable_state();
  ...
  let setSize = prop($$props, "setSize", 8, false);
  let key = prop($$props, "key", 8, void 0);
  let clearButton = prop($$props, "clearButton", 8, false);
  let onBlur = prop($$props, "onBlur", 8, void 0);
  let onEnter = prop($$props, "onEnter", 8, void 0);
  let onSelect = prop($$props, "onSelect", 8, void 0);
  const dispatch = createEventDispatcher();
  let hidden = mutable_state(true);
  let index2 = mutable_state(-1);
  let input = mutable_state(void 0);
  let uid = Math.random().toString(36).slice(2);
  const autocompleteId = `combobox-autocomplete-${uid}`;
  function setValue(next2) {
    value(next2);
    dispatch("change", value());
  }
  function select(suggestion) {
    setValue(get(input) && valueSelector() ? valueSelector()(suggestion, get(input)) : suggestion);
    if (get(input)) {
      onSelect()?.(get(input));
    }
    set(hidden, true);
  ...
  legacy_pre_effect(
    () => (get(input), deep_read_state(valueExtractor()), deep_read_state(value())),
    () => {
      set(extractedValue, get(input) && valueExtractor() ? valueExtractor()(value(), get(input)) : value());
    }
  );
  legacy_pre_effect(
    () => (fuzzyfilter, get(extractedValue), deep_read_state(suggestions()), fuzzywrap),
    () => {
      set(filteredSuggestions, (() => {
        const filtered = fuzzyfilter(get(extractedValue), suggestions()).slice(0, 30).map((suggestion) => ({
          suggestion,
  ...
  legacy_pre_effect(
    () => (get(index2), get(filteredSuggestions)),
    () => {
      set(index2, Math.min(get(index2), get(filteredSuggestions).length - 1));
    }
  );
  legacy_pre_effect(
    () => (get(hidden), get(filteredSuggestions)),
    () => {
      set(expanded, !get(hidden) && get(filteredSuggestions).length > 0);
    }
  );
  ...
  set_attribute(input_1, "aria-controls", autocompleteId);
  bind_this(input_1, ($$value) => set(input, $$value), () => get(input));
  action(input_1, ($$node, $$action_arg) => keyboardShortcut?.($$node, $$action_arg), key);
  effect(() => event("blur", input_1, (event2) => {
    set(hidden, true);
    onBlur()?.(event2.currentTarget);
  }));
  effect(() => event("focus", input_1, () => {
    set(hidden, false);
  }));
  effect(() => event("input", input_1, (event2) => {
    setValue(event2.currentTarget.value);
    set(hidden, false);
  }));
  effect(() => event("keydown", input_1, keydown2));
  ...
  var node_1 = sibling(node, 2);
  {
    var consequent_2 = ($$anchor2) => {
      var ul = root_2();
      set_attribute(ul, "id", autocompleteId);
      each(ul, 7, () => get(filteredSuggestions), ({ fuzzywrapped, suggestion }) => suggestion, ($$anchor3, $$item, i) => {
        let fuzzywrapped = () => get($$item).fuzzywrapped;
        let suggestion = () => get($$item).suggestion;
        var li = root_3();
        each(li, 5, fuzzywrapped, index, ($$anchor4, $$item2) => {
        ...
        template_effect(() => {
          ...
          toggle_class(li, "selected", get(i) === get(index2));
        });
        event("mousedown", li, (event2) => {
          mousedown(event2, suggestion());
        });
        append($$anchor3, li);
      });
      reset(ul);
...
var root_32 = template(`<a class="account-crumb svelte-95cklu"> </a><span class="crumb-sep svelte-95cklu">\u203A</span>`, 1);
var root2 = template(`<strong id="page-title" class="svelte-95cklu"><!></strong>`);
...
function Header($$anchor, $$props) {
  ...
  AutocompleteInput(node_2, {
    ...
    clearButton: true,
    setSize: true,
    onBlur: () => onAccount()(get(accountDraft)),
    onSelect: () => onAccount()(get(accountDraft)),
    onEnter: () => onAccount()(get(accountDraft)),
    $$events: {
      change: (event2) => {
        set(accountDraft, event2.detail);
      }
    }
  });
...
var root_13 = template(`<div class="state-panel loading-panel" role="status" aria-live="polite"><span class="spinner" aria-hidden="true"></span> <span>Loading local view\u2026</span></div>`);
...
function ReportChart($$anchor, $$props) {
  ...
  const iceRects = mutable_state();
  const iceDepth = mutable_state();
  ...
  function collectLeaves(nodes, root21 = "") {
    const out = [];
    for (const node of nodes) {
      const top = root21 || node.name.split(":")[0];
  ...
  function icicleRects(nodes) {
    const rects = [];
    const rowHeight = 6;
    function walk(list, x0, span, depth, root21) {
      ...
      for (const node of list) {
        ...
        if (node.children?.length) {
          walk(node.children, cursor, width2, depth + 1, top);
        }
        cursor += width2;
      }
    }
  ...
  let hierarchyView = mutable_state("treemap");
  function iceColor(rect) {
    const rootsForIce = [
      ...new Set((chart2().nodes ?? []).map((node) => node.name.split(":")[0]))
    ].sort();
    return colors[rootsForIce.indexOf(rect.root) % colors.length];
  }
  function sunburstSegments(nodes) {
    const segments = [];
    function walk(list, a0, span, depth, root21) {
      const total = list.reduce((sum, node) => sum + Math.abs(numberValue(node.value)), 0);
      if (!total || span <= 0) return;
      let cursor = a0;
      for (const node of list) {
  ...
  function sunColor(segment) {
    const rootsForSun = [
      ...new Set((chart2().nodes ?? []).map((node) => node.name.split(":")[0]))
    ].sort();
    return colors[rootsForSun.indexOf(segment.root) % colors.length];
  }
  function arcPath(segment) {
    const ring = 46 / get(sunDepth);
    ...
    const px = (radius, angle) => (50 + radius * Math.sin(angle)).toFixed(2);
    const py = (radius, angle) => (50 - radius * Math.cos(angle)).toFixed(2);
  ...
  function moveTooltip(event2, anchor) {
  ...
  function showLineTip(event2) {
    const svg = event2.currentTarget;
    const points = chart2().series[0]?.points ?? [];
    if (!points.length) return;
    const box = svg.getBoundingClientRect();
    if (!box.width) return;
    const viewBoxX = (event2.clientX - box.left) / box.width * 100;
    const step = get(width) === 1 ? 1 : (X1 - X0) / (get(width) - 1);
    const index2 = Math.max(0, Math.min(points.length - 1, Math.round((viewBoxX - X0) / step)));
    const lines = get(visibleSeries).map((series) => {
      const value = series.points[index2]?.value.display;
      return value === void 0 ? "" : `${series.label}: ${value}`;
    }).filter(Boolean);
    if (!lines.length) return;
    set(tooltipText, `${points[index2].date}
${lines.join("\n")}`);
    set(tooltipVisible, true);
    moveTooltip(event2, svg);
  }
  legacy_pre_effect(
    () => (translations, deep_read_state(locale())),
    () => {
  ...
  legacy_pre_effect(() => deep_read_state(chart2()), () => {
    set(xTickIndices, (() => {
      const points = chart2().series[0]?.points ?? [];
      if (points.length <= 6) return points.map((_, index2) => index2);
      const count = 5;
      const indices = [];
  ...
  var node_1 = sibling(h3, 2);
  {
    var consequent_2 = ($$anchor2) => {
      ...
      template_effect(() => set_text(text_1, label("treemap")));
      reset(button);
      var button_1 = sibling(button, 2);
      var text_2 = child(button_1, true);
      template_effect(() => set_text(text_2, label("sunburst")));
      reset(button_1);
      var button_2 = sibling(button_1, 2);
      var text_3 = child(button_2, true);
      template_effect(() => set_text(text_3, label("icicle")));
      reset(button_2);
      reset(div);
      var node_2 = sibling(div, 2);
      {
        ...
        var alternate_1 = ($$anchor3) => {
          ...
          var node_3 = first_child(fragment_1);
          {
            ...
            if_block(
              node_3,
              ($$render) => {
                if (get(hierarchyView) === "icicle" && get(iceRects).length) $$render(consequent_1);
                else $$render(alternate, false);
              },
              true
            );
        ...
        if_block(node_2, ($$render) => {
          if (get(hierarchyView) === "sunburst" && get(sunSegments).length) $$render(consequent);
          else $$render(alternate_1, false);
        });
      }
      template_effect(() => {
        toggle_class(button, "selected", get(hierarchyView) === "treemap");
        toggle_class(button_1, "selected", get(hierarchyView) === "sunburst");
        toggle_class(button_2, "selected", get(hierarchyView) === "icicle");
      });
      event("click", button, () => set(hierarchyView, "treemap"));
      event("click", button_1, () => set(hierarchyView, "sunburst"));
      event("click", button_2, () => set(hierarchyView, "icicle"));
      append($$anchor2, fragment);
    };
    var alternate_3 = ($$anchor2) => {
      ...
      var node_4 = first_child(fragment_2);
      {
        var consequent_4 = ($$anchor3) => {
          var svg_4 = root_11();
          var node_5 = child(svg_4);
          each(node_5, 1, () => get(yTicks), (tick2) => tick2, ($$anchor4, tick2) => {
            var fragment_3 = root_122();
            var line = first_child(fragment_3);
            ...
            var text_7 = sibling(line);
            set_attribute(text_7, "x", X0 - 1);
            template_effect(() => set_attribute(text_7, "y", y(get(tick2)) + 1));
            var text_8 = child(text_7, true);
            template_effect(() => set_text(text_8, tickLabel(get(tick2))));
            reset(text_7);
            append($$anchor4, fragment_3);
          });
          var line_1 = sibling(node_5);
          ...
          each(node_6, 3, () => get(visibleSeries), (series) => series.label, ($$anchor4, series, seriesIndex) => {
            ...
            each(node_7, 3, () => get(series).points, (point) => point.date, ($$anchor5, point, index2) => {
              ...
              event("mousemove", rect_3, (e) => showBarTip(e, get(series).label, get(point)));
              event("mouseleave", rect_3, hideTip);
              append($$anchor5, rect_3);
            });
            append($$anchor4, fragment_4);
          });
          var node_8 = sibling(node_6);
          each(node_8, 1, () => get(xTickIndices), (index2) => index2, ($$anchor4, index2) => {
            ...
            var node_9 = first_child(fragment_5);
            {
              var consequent_3 = ($$anchor5) => {
                var text_9 = root_16();
                template_effect(() => set_attribute(text_9, "x", x(get(index2))));
                var text_10 = child(text_9, true);
                template_effect(() => set_text(text_10, xTickLabel(get(point).date)));
                reset(text_9);
                append($$anchor5, text_9);
              };
              if_block(node_9, ($$render) => {
                if (get(point)) $$render(consequent_3);
              });
            }
            append($$anchor4, fragment_5);
          });
          reset(svg_4);
          template_effect(() => set_attribute(svg_4, "aria-label", chart2().title));
          append($$anchor3, svg_4);
        };
        var alternate_2 = ($$anchor3) => {
          var svg_5 = root_17();
          var node_10 = child(svg_5);
          each(node_10, 1, () => get(yTicks), (tick2) => tick2, ($$anchor4, tick2) => {
            var fragment_6 = root_18();
            var line_2 = first_child(fragment_6);
            set_attribute(line_2, "x1", X0);
            template_effect(() => set_attribute(line_2, "y1", y(get(tick2))));
            set_attribute(line_2, "x2", X1);
            template_effect(() => set_attribute(line_2, "y2", y(get(tick2))));
            var text_11 = sibling(line_2);
          ...
          var line_3 = sibling(node_10);
          set_attribute(line_3, "x1", X0);
          template_effect(() => set_attribute(line_3, "y1", y(0)));
          ...
          each(node_12, 1, () => get(xTickIndices), (index2) => index2, ($$anchor4, index2) => {
            ...
            var node_13 = first_child(fragment_7);
            {
              ...
              if_block(node_13, ($$render) => {
                if (get(point)) $$render(consequent_5);
              });
            }
            append($$anchor4, fragment_7);
          });
          reset(svg_5);
          template_effect(() => set_attribute(svg_5, "aria-label", chart2().title));
          event("mousemove", svg_5, showLineTip);
          event("mouseleave", svg_5, hideTip);
          append($$anchor3, svg_5);
        };
        if_block(
          node_4,
          ($$render) => {
            if (chart2().kind === "stacked-bar" || chart2().kind === "bar") $$render(consequent_4);
    ...
    if_block(node_1, ($$render) => {
      if (chart2().kind === "hierarchy" && (get(tiles).length || get(iceRects).length || get(sunSegments).length)) $$render(consequent_2);
  ...
  var node_15 = sibling(node_14, 2);
  {
    var consequent_6 = ($$anchor2) => {
      var p_1 = root_23();
      var text_17 = child(p_1, true);
      reset(p_1);
      template_effect(() => set_text(text_17, get(availabilityText)));
      append($$anchor2, p_1);
    };
    if_block(node_15, ($$render) => {
      if (get(availabilityText)) $$render(consequent_6);
    });
  }
  var details = sibling(node_15, 2);
  var summary = child(details);
  var text_18 = child(summary, true);
  template_effect(() => set_text(text_18, label("chartData")));
  reset(summary);
  var div_1 = sibling(summary, 2);
  var table = child(div_1);
  var thead = child(table);
  var tr = child(thead);
  var node_16 = sibling(child(tr));
  each(node_16, 1, () => chart2().series, (series) => series.label, ($$anchor2, series) => {
    var th = root_24();
    var text_19 = child(th, true);
    reset(th);
    template_effect(() => set_text(text_19, get(series).label));
    append($$anchor2, th);
  });
  reset(tr);
  reset(thead);
  ...
  each(
    ...
    ($$anchor2, point, index2) => {
      var tr_1 = root_25();
      var th_1 = child(tr_1);
      var text_20 = child(th_1, true);
      reset(th_1);
      var node_17 = sibling(th_1);
      each(node_17, 1, () => chart2().series, (series) => series.label, ($$anchor3, series) => {
        var td = root_26();
        var text_21 = child(td, true);
        template_effect(() => set_text(text_21, formatAmount(get(series).points[get(index2)]?.value)));
        reset(td);
        append($$anchor3, td);
      });
      reset(tr_1);
      template_effect(() => set_text(text_20, get(point).date));
      append($$anchor2, tr_1);
    },
    ($$anchor2) => {
      var tr_2 = root_27();
  ...
  reset(div_1);
  reset(details);
  var node_18 = sibling(details, 2);
  {
    var consequent_7 = ($$anchor2) => {
      var div_2 = root_28();
      var text_22 = child(div_2, true);
      reset(div_2);
      template_effect(() => {
        set_attribute(div_2, "style", `left:${get(tooltipLeft)}px;top:${get(tooltipTop)}px`);
        set_text(text_22, get(tooltipText));
      });
      append($$anchor2, div_2);
    };
    if_block(node_18, ($$render) => {
      if (get(tooltipVisible)) $$render(consequent_7);
    });
  }
  reset(section);
  template_effect(() => {
    ...
    set_text(text_15, `${chart2().interval ?? ""} \xB7 ${chart2().valuation ?? ""}${(chart2().currency ? ` \xB7 ${chart2().currency}` : "") ?? ""}`);
  });
...
var root_110 = template(`<h2> </h2>`);
var root_29 = template(`<a class="button">Export CSV</a>`);
var on_click = (_, toggleSort, column) => toggleSort(get(column));
var root_5 = template(`<span aria-hidden="true"> </span>`);
...
function GenericReport($$anchor, $$props) {
  ...
  let sortColumn = mutable_state("");
  let sortDirection = mutable_state(null);
  ...
  legacy_pre_effect(
    () => (get(sortDirection), deep_read_state(report()), get(sortColumn)),
    () => {
      set(sortedRows, (() => {
        if (!get(sortDirection)) return report().rows;
        const factor = get(sortDirection) === "ascending" ? 1 : -1;
        return [...report().rows].sort((a, b) => {
          const left = a[get(sortColumn)];
          const right = b[get(sortColumn)];
  ...
  var node_1 = sibling(span, 2);
  {
    var consequent_1 = ($$anchor2) => {
      var a_1 = root_29();
      template_effect(() => set_attribute(a_1, "href", `/api/v1/reports/${route()}?format=csv`));
      append($$anchor2, a_1);
    };
    if_block(node_1, ($$render) => {
      if (route()) $$render(consequent_1);
    });
  }
  reset(div);
  var node_2 = sibling(div, 2);
  {
    ...
    if_block(node_2, ($$render) => {
      if (report().chart) $$render(consequent_2);
    });
  }
  ...
  each(tr, 5, () => report().columns, (column) => column, ($$anchor2, column) => {
    ...
    var node_3 = sibling(text_2);
    {
      ...
      if_block(node_3, ($$render) => {
        if (get(sortColumn) === get(column)) $$render(consequent_3);
      });
    }
    reset(button);
    reset(th);
    template_effect(() => {
      set_attribute(th, "aria-sort", get(sortColumn) === get(column) ? get(sortDirection) : void 0);
      toggle_class(th, "num", get(class_directive));
      set_text(text_2, get(column));
    });
    append($$anchor2, th);
  });
  reset(tr);
      ...
      each(tr_1, 5, () => report().columns, (column) => column, ($$anchor3, column) => {
        ...
        var node_4 = child(td);
        {
          var consequent_4 = ($$anchor4) => {
            var a_2 = root_82();
            template_effect(() => set_attribute(a_2, "href", `/documents/${encodeURIComponent(get(row)[get(column)])}`));
          ...
          var alternate_1 = ($$anchor4) => {
            ...
            var node_5 = first_child(fragment_2);
            {
              var consequent_5 = ($$anchor5) => {
                var a_3 = root_10();
                template_effect(() => set_attribute(a_3, "href", `/source?path=${encodeURIComponent(get(row)[get(column)])}`));
              ...
              var alternate = ($$anchor5) => {
                var text_6 = text();
                template_effect(() => set_text(text_6, display(get(row)[get(column)])));
                append($$anchor5, text_6);
              };
              if_block(
                node_5,
                ($$render) => {
                  if (["file", "path"].includes(get(column)) && typeof get(row)[get(column)] === "string") $$render(consequent_5);
                  else $$render(alternate, false);
                },
                true
              );
          ...
          if_block(node_4, ($$render) => {
            if (route() === "documents" && get(column) === "filename" && typeof get(row)[get(column)] === "string") $$render(consequent_4);
            else $$render(alternate_1, false);
          });
        }
        reset(td);
  ...
  reset(table);
  reset(div_1);
  template_effect(() => set_text(text_1, `${report().rows.length ?? ""} rows`));
  append($$anchor, fragment);
  pop();
}
delegate(["click"]);
...
var root_102 = template(`<span class="metadata-indicator"> </span>`);
var root_124 = template(`<span class="metadata-indicator"> </span>`);
var root_112 = template(`<span></span> <!>`, 1);
var root_92 = template(`<span class="indicators" role="button" tabindex="0" title="Toggle postings"><!> <!></span>`);
var root_142 = template(`<span class="metadata-indicator"> </span>`);
var root_132 = template(`<span class="indicators"></span>`);
var root_152 = template(`<span class="num bal"> </span> <span class="change num"></span> <span class="change num"> </span>`, 1);
var root_172 = template(`<span class="num"></span> <span class="num"></span> <span class="num"> </span>`, 1);
var root_192 = template(`<span class="num"></span> <span class="num"></span> <span class="num change"> </span>`, 1);
var root_232 = template(`<dt> </dt> <dd> </dd>`, 1);
...
function JournalReport($$anchor, $$props) {
  ...
  const chips = [
    ...
    },
    {
      ...
      shortcut: "s d",
      children: ["show-discovered", "show-linked"]
    },
    {
      label: "D",
      cls: "show-discovered",
      title: "Documents with a #discovered tag",
      shortcut: "d d"
    },
    {
      label: "L",
      cls: "show-linked",
      title: "Documents with a #linked tag",
      shortcut: "d l"
    },
    {
      label: "Pad",
  ...
  function postingFlagClass(flag) {
    if (!flag) return "";
  ...
  each(node_1, 3, () => get(sortedEntries), (entry, index2) => entry.type + entry.date + index2, ($$anchor2, entry) => {
    ...
    var node_7 = sibling(node_6, 2);
    {
      var consequent_2 = ($$anchor3) => {
        var a_1 = root_83();
        template_effect(() => set_attribute(a_1, "href", `#context-${get(entry).entry_hash ?? ""}`));
        append($$anchor3, a_1);
      };
      if_block(node_7, ($$render) => {
        if (get(entry).entry_hash) $$render(consequent_2);
      });
    }
    reset(span_3);
    var node_8 = sibling(span_3, 2);
    {
      var consequent_3 = ($$anchor3) => {
        ...
        each(node_9, 1, () => get(entry).metadata ?? [], (meta) => meta.key, ($$anchor4, meta) => {
          var span_8 = root_102();
          var text_10 = child(span_8, true);
          template_effect(() => set_text(text_10, get(meta).key.slice(0, 2)));
          reset(span_8);
          template_effect(() => set_attribute(span_8, "title", `${get(meta).key ?? ""}: ${get(meta).value ?? ""}`));
          append($$anchor4, span_8);
        });
        var node_10 = sibling(node_9, 2);
        each(node_10, 1, () => get(entry).postings, index, ($$anchor4, posting) => {
          ...
          each(node_11, 1, () => get(posting).metadata ?? [], (meta) => meta.key, ($$anchor5, meta) => {
            var span_10 = root_124();
            var text_11 = child(span_10, true);
            template_effect(() => set_text(text_11, get(meta).key.slice(0, 2)));
            reset(span_10);
            template_effect(() => set_attribute(span_10, "title", `${get(meta).key ?? ""}: ${get(meta).value ?? ""}`));
            append($$anchor5, span_10);
          });
          template_effect(() => set_class(span_9, get(class_derived_1)));
          append($$anchor4, fragment_2);
        });
        reset(span_7);
      ...
      var alternate = ($$anchor3) => {
        var span_11 = root_132();
        each(span_11, 5, () => get(entry).metadata ?? [], (meta) => meta.key, ($$anchor4, meta) => {
          var span_12 = root_142();
          var text_12 = child(span_12, true);
          template_effect(() => set_text(text_12, get(meta).key.slice(0, 2)));
          reset(span_12);
          template_effect(() => set_attribute(span_12, "title", `${get(meta).key ?? ""}: ${get(meta).value ?? ""}`));
      ...
      if_block(node_8, ($$render) => {
        if (get(entry).postings?.length) $$render(consequent_3);
        else $$render(alternate, false);
      });
    }
    var node_12 = sibling(node_8, 2);
    {
      var consequent_4 = ($$anchor3) => {
        ...
        var span_13 = first_child(fragment_3);
        var text_13 = child(span_13, true);
        template_effect(() => set_text(text_13, amountText(get(entry).amount)));
        reset(span_13);
        var span_14 = sibling(span_13, 4);
        var text_14 = child(span_14, true);
        template_effect(() => set_text(text_14, accountFilter() ? changeText(get(entry).change) : ""));
        reset(span_14);
        template_effect(() => set_attribute(span_13, "title", get(entry).amount.currency));
      ...
      var alternate_2 = ($$anchor3) => {
        ...
        var node_13 = first_child(fragment_4);
        {
          var consequent_5 = ($$anchor4) => {
            ...
            var span_15 = sibling(first_child(fragment_5), 4);
            var text_15 = child(span_15, true);
            template_effect(() => set_text(text_15, runningBalances().get(get(entry)) ?? ""));
            reset(span_15);
            append($$anchor4, fragment_5);
          };
          var alternate_1 = ($$anchor4) => {
            ...
            var node_14 = first_child(fragment_6);
            {
              var consequent_6 = ($$anchor5) => {
                var fragment_7 = root_192();
                var span_16 = sibling(first_child(fragment_7), 4);
                var text_16 = child(span_16, true);
                template_effect(() => set_text(text_16, changeText(get(entry).change)));
                reset(span_16);
              ...
              if_block(
                node_14,
                ($$render) => {
                  if (accountFilter()) $$render(consequent_6);
                },
                true
              );
            }
          ...
          if_block(
            node_13,
            ($$render) => {
              if (runningBalances()) $$render(consequent_5);
              else $$render(alternate_1, false);
            },
            true
          );
      ...
      if_block(node_12, ($$render) => {
        if (get(entry).amount) $$render(consequent_4);
        else $$render(alternate_2, false);
      });
    }
    reset(p_1);
    var node_15 = sibling(p_1, 2);
    {
      var consequent_8 = ($$anchor3) => {
        ...
        each(ul, 7, () => get(entry).postings, (posting, postingIndex) => posting.account + postingIndex, ($$anchor4, posting) => {
          ...
          var a_2 = child(span_18);
          template_effect(() => set_attribute(a_2, "href", accountHref(get(posting).account)));
          var text_18 = child(a_2, true);
          reset(a_2);
          reset(span_18);
          var span_19 = sibling(span_18, 2);
          var text_19 = child(span_19, true);
          template_effect(() => set_text(text_19, amountText(get(posting).units)));
          reset(span_19);
          var span_20 = sibling(span_19, 2);
          var text_20 = child(span_20, true);
          template_effect(() => set_text(text_20, amountText(get(posting).cost)));
          reset(span_20);
          var span_21 = sibling(span_20, 2);
          var text_21 = child(span_21, true);
          template_effect(() => set_text(text_21, amountText(get(posting).price)));
          reset(span_21);
          reset(p_2);
          var node_16 = sibling(p_2, 2);
          {
            var consequent_7 = ($$anchor5) => {
              var dl = root_223();
              each(dl, 5, () => get(posting).metadata, (meta) => meta.key, ($$anchor6, meta) => {
                var fragment_8 = root_232();
                var dt = first_child(fragment_8);
                var text_22 = child(dt);
                reset(dt);
                var dd = sibling(dt, 2);
                var text_23 = child(dd, true);
                reset(dd);
                template_effect(() => {
                  set_text(text_22, `${get(meta).key ?? ""}:`);
                  set_text(text_23, get(meta).value);
                });
      ...
      if_block(node_15, ($$render) => {
        if (get(entry).postings?.length) $$render(consequent_8);
      });
    }
    var node_17 = sibling(node_15, 2);
    {
      var consequent_9 = ($$anchor3) => {
        var dl_1 = root_242();
        each(dl_1, 5, () => get(entry).metadata, (meta) => meta.key, ($$anchor4, meta) => {
          var fragment_9 = root_252();
          var dt_1 = first_child(fragment_9);
          ...
          reset(dd_1);
          template_effect(() => {
            set_text(text_24, `${get(meta).key ?? ""}:`);
            set_text(text_25, get(meta).value);
          });
...
function AccountReport($$anchor, $$props) {
  ...
  const reportType = mutable_state();
  const intervalLabel = mutable_state();
  const parts = mutable_state();
  ...
  function ancestors(name) {
    ...
    while (index2 !== -1) {
      result.push(name.slice(0, index2));
      index2 = name.indexOf(":", index2 + 1);
    }
  ...
  function sectionHref(mode) {
    ...
    return `/account/${encodeURIComponent(get(account))}${suffix}`;
  }
  async function load(key) {
    try {
      ...
      if (get(reportType) !== "journal") {
        requests.push(adapter().load("account", { ...query(), r: get(reportType) }));
      }
      const values = await Promise.all(requests);
      if (key !== get(requestKey)) return;
      set(balance, parseTableReport(values[0]));
      set(journal, parseJournalReport(values[1]));
      set(intervals, get(reportType) !== "journal" ? parseTableReport(values[2]) : null);
      set(error, "");
    } catch (value) {
      if (key !== get(requestKey)) return;
  ...
  legacy_pre_effect(() => deep_read_state(query()), () => {
    set(reportType, query().r === "changes" || query().r === "balances" ? query().r : "journal");
  });
  legacy_pre_effect(() => deep_read_state(query()), () => {
    set(intervalLabel, intervalLabelFor(query().interval || "month"));
  });
  legacy_pre_effect(() => get(account), () => {
    set(parts, ancestors(get(account)));
  });
  ...
  var node = first_child(fragment);
  {
    ...
    var alternate_4 = ($$anchor2) => {
      ...
      each(node_1, 3, () => get(parts), (name) => name, ($$anchor3, name, index2) => {
        ...
        var a = first_child(fragment_2);
        template_effect(() => set_attribute(a, "href", accountHref(get(name))));
        var text_1 = child(a, true);
        template_effect(() => set_text(text_1, leaf(get(name))));
        reset(a);
        ...
        template_effect(() => set_attribute(a, "title", get(name)));
      ...
      var node_4 = child(h3);
      {
        var consequent_3 = ($$anchor3) => {
          var a_1 = root_65();
          template_effect(() => set_attribute(a_1, "href", sectionHref("")));
          var text_3 = child(a_1, true);
          template_effect(() => set_text(text_3, t("accountBalance")));
          reset(a_1);
          append($$anchor3, a_1);
        };
        var alternate = ($$anchor3) => {
          var text_4 = text();
          template_effect(() => set_text(text_4, t("accountBalance")));
          append($$anchor3, text_4);
        };
        if_block(node_4, ($$render) => {
          if (get(reportType) !== "journal") $$render(consequent_3);
          else $$render(alternate, false);
        });
      }
      reset(h3);
      ...
      var node_5 = child(h3_1);
      {
        var consequent_4 = ($$anchor3) => {
          var a_2 = root_84();
          template_effect(() => set_attribute(a_2, "href", sectionHref("changes")));
          var text_5 = child(a_2);
          template_effect(() => set_text(text_5, `${t("changes") ?? ""} (${get(intervalLabel) ?? ""})`));
          reset(a_2);
          append($$anchor3, a_2);
        };
        var alternate_1 = ($$anchor3) => {
          var text_6 = text();
          template_effect(() => set_text(text_6, `${t("changes") ?? ""} (${get(intervalLabel) ?? ""})`));
          append($$anchor3, text_6);
        };
        if_block(node_5, ($$render) => {
          if (get(reportType) !== "changes") $$render(consequent_4);
          else $$render(alternate_1, false);
        });
      }
      reset(h3_1);
      ...
      var node_6 = child(h3_2);
      {
        var consequent_5 = ($$anchor3) => {
          var a_3 = root_103();
          template_effect(() => set_attribute(a_3, "href", sectionHref("balances")));
          var text_7 = child(a_3);
          template_effect(() => set_text(text_7, `${t("balances") ?? ""} (${get(intervalLabel) ?? ""})`));
          reset(a_3);
          append($$anchor3, a_3);
        };
        var alternate_2 = ($$anchor3) => {
          var text_8 = text();
          template_effect(() => set_text(text_8, `${t("balances") ?? ""} (${get(intervalLabel) ?? ""})`));
          append($$anchor3, text_8);
        };
        if_block(node_6, ($$render) => {
          if (get(reportType) !== "balances") $$render(consequent_5);
          else $$render(alternate_2, false);
        });
      }
      reset(h3_2);
      ...
      var node_7 = sibling(div_1, 2);
      {
        var consequent_7 = ($$anchor3) => {
          ...
          var node_8 = first_child(fragment_6);
          {
            var consequent_6 = ($$anchor4) => {
              var title = derived_safe_equal(() => `${get(reportType) === "changes" ? t("changes") : t("balances")} (${get(intervalLabel)})`);
            ...
            if_block(node_8, ($$render) => {
              if (get(intervals)) $$render(consequent_6);
            });
          }
        ...
        var alternate_3 = ($$anchor3) => {
          ...
          var node_9 = first_child(fragment_8);
          {
            ...
            if_block(
              node_9,
              ($$render) => {
                if (get(balance)) $$render(consequent_8);
              },
              true
            );
          }
        ...
        if_block(node_7, ($$render) => {
          if (get(reportType) === "changes" || get(reportType) === "balances") $$render(consequent_7);
          else $$render(alternate_3, false);
        });
      }
...
function HoldingsReport($$anchor, $$props) {
  ...
  const tabs = [
    ...
    {
      route: "holdings_by_account",
      key: "holdingsByAccount"
    },
    {
    ...
    },
    {
      ...
      key: "holdingsByRootAccount"
    },
    {
      route: "holdings_by_commodity",
      key: "holdingsByCommodity"
    }
  ];
  function columnLabel(column) {
    return column.split("_").map((part) => part ? part[0].toUpperCase() + part.slice(1) : part).join(" ");
  }
  legacy_pre_effect(() => deep_read_state(route()), () => {
    set(aggregation, route().startsWith("holdings_by_") ? route().slice("holdings_".length) : "");
  });
  legacy_pre_effect(() => get(aggregation), () => {
    set(csvHref, get(aggregation) ? `/api/v1/reports/holdings?format=csv&aggregation=${encodeURIComponent(get(aggregation))}` : "/api/v1/reports/holdings?format=csv");
  });
  legacy_pre_effect(() => deep_read_state(report()), () => {
    set(labeled, (() => {
      ...
      return {
        ...
        rows: report().rows.map((row) => Object.fromEntries(Object.entries(row).map(([key, value]) => [rename.get(key) ?? key, value])))
      };
    })());
  });
  legacy_pre_effect_reset();
  ...
  each(node, 1, () => tabs, (tab) => tab.route, ($$anchor2, tab) => {
    ...
    var node_1 = child(h3);
    {
      var consequent = ($$anchor3) => {
        var text2 = text();
        template_effect(() => set_text(text2, t(get(tab).key)));
      ...
      var alternate = ($$anchor3) => {
        ...
        var text_1 = child(a, true);
        template_effect(() => set_text(text_1, t(get(tab).key)));
        reset(a);
        append($$anchor3, a);
      };
      if_block(node_1, ($$render) => {
        if (get(tab).route === route()) $$render(consequent);
        else $$render(alternate, false);
      });
    }
    reset(h3);
  ...
  template_effect(() => set_text(text_2, t("exportCSV")));
  reset(a_1);
  reset(div);
  var node_2 = sibling(div, 2);
  ...
  template_effect(() => set_attribute(a_1, "href", get(csvHref)));
  append($$anchor, fragment);
  pop();
}
...
var root_116 = template(`<th class="svelte-21kpbq"><button type="button" class="sort-toggle svelte-21kpbq"> <!></button></th>`);
var root_38 = template(`<th class="svelte-21kpbq"> </th>`);
function SortHeader($$anchor, $$props) {
  ...
  let numeric = prop($$props, "numeric", 8, false);
  legacy_pre_effect(
    () => (deep_read_state(column()), UnsortedColumn),
    () => {
      set(sortable, !(column() instanceof UnsortedColumn));
    }
  );
  legacy_pre_effect(
    () => (deep_read_state(column()), deep_read_state(sorter())),
    () => {
      set(active, column() === sorter().column);
    }
  );
  legacy_pre_effect_reset();
  init();
  ...
  var node = first_child(fragment);
  {
    var consequent_1 = ($$anchor2) => {
      ...
      reset(th);
      template_effect(() => {
        set_attribute(th, "aria-sort", get(active) ? sorter().order === "asc" ? "ascending" : "descending" : void 0);
        toggle_class(th, "num", numeric());
        set_text(text2, column().name);
      });
      event("click", button, () => sorter(sorter().switchColumn(column())));
      append($$anchor2, th);
    };
    var alternate = ($$anchor2) => {
      var th_1 = root_38();
      ...
      reset(th_1);
      template_effect(() => {
        toggle_class(th_1, "num", numeric());
        set_text(text_2, column().name);
      });
      append($$anchor2, th_1);
    };
    if_block(node, ($$render) => {
      if (get(sortable)) $$render(consequent_1);
      else $$render(alternate, false);
    });
  }
  append($$anchor, fragment);
...
var root_117 = template(`<tr><td> </td><td class="num svelte-wqxbcw"> </td></tr>`);
var root_46 = template(`<span> </span><br>`, 1);
var root_39 = template(`<tr><td class="account svelte-wqxbcw"><a> </a></td><td><a> </a></td><td class="num svelte-wqxbcw"></td></tr>`);
var root_215 = template(`<div class="left"><h3> </h3> <table class="update-activity svelte-wqxbcw"><thead><tr><!><!><!></tr></thead><tbody></tbody></table></div>`);
var root8 = template(`<div class="left"><h3> </h3> <!></div> <div class="left"><h3> </h3> <table class="entries-by-type svelte-wqxbcw"><thead><tr><!><!></tr></thead><tbody></tbody><tfoot class="svelte-wqxbcw"><tr><td class="svelte-wqxbcw"> </td><td class="num svelte-wqxbcw"> </td></tr></tfoot></table></div> <!>`, 1);
function StatisticsReport($$anchor, $$props) {
  push($$props, false);
  const total = mutable_state();
  const entryColumns = mutable_state();
  const entrySorter = mutable_state();
  const sortedEntries = mutable_state();
  const activityColumns = mutable_state();
  const activitySorter = mutable_state();
  const sortedActivity = mutable_state();
  ...
  legacy_pre_effect(() => deep_read_state(entriesByType()), () => {
    set(total, entriesByType().reduce((sum, [, count]) => sum + count, 0));
  });
  legacy_pre_effect(() => (StringColumn, NumberColumn), () => {
    set(entryColumns, [
      new StringColumn(t("type"), (row) => row[0]),
      new NumberColumn(t("entriesCount"), (row) => row[1])
    ]);
  });
  legacy_pre_effect(() => (Sorter, get(entryColumns)), () => {
    set(entrySorter, new Sorter(get(entryColumns)[0], "asc"));
  });
  legacy_pre_effect(
    () => (get(entrySorter), deep_read_state(entriesByType())),
    () => {
      set(sortedEntries, get(entrySorter).sort(entriesByType()));
    }
  );
  legacy_pre_effect(() => (StringColumn, UnsortedColumn), () => {
    set(activityColumns, [
      new StringColumn(t("account"), (row) => row.account),
      new StringColumn(t("updateActivityLastEntry"), (row) => row.last_entry_date),
      new UnsortedColumn(t("accountBalance"))
    ]);
  });
  legacy_pre_effect(() => (Sorter, get(activityColumns)), () => {
    set(activitySorter, new Sorter(get(activityColumns)[0], "asc"));
  });
  legacy_pre_effect(
    () => (get(activitySorter), deep_read_state(updateActivity())),
    () => {
      set(sortedActivity, get(activitySorter).sort(updateActivity()));
    }
  );
  legacy_pre_effect_reset();
  init();
  ...
  var h3 = child(div);
  var text2 = child(h3, true);
  template_effect(() => set_text(text2, t("postingsPerAccount")));
  reset(h3);
  ...
  template_effect(() => set_text(text_1, t("entriesPerType")));
  reset(h3_1);
  ...
  SortHeader(node_1, {
    get column() {
      return get(entryColumns)[0];
    },
    get sorter() {
      return get(entrySorter);
    },
    set sorter($$value) {
      set(entrySorter, $$value);
    },
    $$legacy: true
  });
  ...
  template_effect(() => set_text(text_4, t("total")));
  reset(td_2);
  var td_3 = sibling(td_2);
  ...
  var node_3 = sibling(div_1, 2);
  {
    var consequent = ($$anchor2) => {
      ...
      template_effect(() => set_text(text_6, t("updateActivity")));
      reset(h3_2);
      ...
      SortHeader(node_4, {
        get column() {
          return get(activityColumns)[0];
        },
        get sorter() {
          return get(activitySorter);
        },
        set sorter($$value) {
          set(activitySorter, $$value);
        },
        $$legacy: true
      });
      ...
      each(tbody_1, 5, () => get(sortedActivity), (row) => row.account, ($$anchor3, row) => {
        ...
        each(td_6, 5, () => Object.entries(get(row).balances), ([currency, amount]) => currency, ($$anchor4, $$item) => {
          ...
          var fragment_1 = root_46();
          var span = first_child(fragment_1);
          var text_9 = child(span);
          reset(span);
          next();
          template_effect(() => set_text(text_9, `${amount() ?? ""} ${currency() ?? ""}`));
          append($$anchor4, fragment_1);
        });
        reset(td_6);
        reset(tr_4);
        template_effect(() => {
          set_text(text_7, get(row).account);
          set_attribute(a_1, "href", `#context-${get(row).entry_hash}`);
          set_text(text_8, get(row).last_entry_date);
        });
        append($$anchor3, tr_4);
      });
      reset(tbody_1);
    ...
    if_block(node_3, ($$render) => {
      if (updateActivity().length) $$render(consequent);
    });
  }
...
var root_120 = template(`<tr><td> </td><td class="num svelte-pjz8y6"> </td></tr>`);
var root11 = template(`<table class="prices-table svelte-pjz8y6"><thead><tr><!><!></tr></thead><tbody></tbody></table>`);
function PriceTable($$anchor, $$props) {
  ...
  legacy_pre_effect(() => (DateColumn, NumberColumn), () => {
    set(columns, [
      new DateColumn(t("date")),
      new NumberColumn(t("price"), priceValue)
    ]);
  });
  ...
  legacy_pre_effect(
    ...
    () => {
      set(sorted, get(sorter).sort(prices()));
    }
  );
  legacy_pre_effect_reset();
  init();
  ...
  each(tbody, 5, () => get(sorted), (price) => price.date, ($$anchor2, price) => {
    ...
    template_effect(() => set_text(text_1, formatAmount(get(price).amount, renderCommas())));
    reset(td_1);
    reset(tr_1);
    template_effect(() => set_text(text2, get(price).date));
    append($$anchor2, tr_1);
  });
  reset(tbody);
  reset(table);
...
var root_217 = template(`<div class="left"><h3> </h3> <!></div>`);
var root_312 = template(`<p> </p>`);
function CommoditiesReport($$anchor, $$props) {
  ...
  var node = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
      var fragment_1 = comment();
      var node_1 = first_child(fragment_1);
      each(node_1, 1, () => get(pairs), ([pair, prices]) => pair, ($$anchor3, $$item) => {
        let pair = () => get($$item)[0];
        let prices = () => get($$item)[1];
        var div = root_217();
        var h3 = child(div);
        var text2 = child(h3, true);
        reset(h3);
        ...
        reset(div);
        template_effect(() => set_text(text2, pair()));
        append($$anchor3, div);
      });
      append($$anchor2, fragment_1);
    };
    var alternate = ($$anchor2) => {
      var p = root_312();
      var text_1 = child(p, true);
      template_effect(() => set_text(text_1, t("noPrices")));
      reset(p);
      append($$anchor2, p);
    };
    if_block(node, ($$render) => {
      if (get(pairs).length) $$render(consequent);
      else $$render(alternate, false);
    });
  }
  append($$anchor, fragment);
...
var root_218 = template(`<button type="button" class="unset toggle svelte-1se7z4w"> </button>`);
var root_313 = template(`<span class="count svelte-1se7z4w"> </span>`);
var root_121 = template(`<p class="droptarget svelte-1se7z4w"><!> <button type="button" class="unset leaf svelte-1se7z4w"> </button> <!></p>`);
var root_55 = template(`<li><!></li>`);
var root_47 = template(`<ul class="svelte-1se7z4w"></ul>`);
var root12 = template(`<!> <!>`, 1);
function DocumentAccounts($$anchor, $$props) {
  push($$props, false);
  const account = mutable_state();
  const leafName = mutable_state();
  const hasChildren = mutable_state();
  const isToggled = mutable_state();
  const selected = mutable_state();
  let node = prop($$props, "node", 8);
  let toggled = prop($$props, "toggled", 12);
  let selectedAccount = prop($$props, "selectedAccount", 8);
  const dispatch = createEventDispatcher();
  ...
  function drop(event2) {
    ...
    if (filename != null && filename !== "") {
      dispatch("move", { account: get(account), filename });
      set(drag, false);
    }
  }
  function toggle() {
    toggled(get(isToggled) ? new Set([...toggled()].filter((name) => name !== get(account))) : /* @__PURE__ */ new Set([...toggled(), get(account)]));
  }
  function select() {
    dispatch("select", get(selected) ? "" : get(account));
  }
  legacy_pre_effect(() => deep_read_state(node()), () => {
    set(account, node().name);
  });
  legacy_pre_effect(() => get(account), () => {
    set(leafName, get(account).split(":").pop() || get(account));
  });
  legacy_pre_effect(() => deep_read_state(node()), () => {
    set(hasChildren, node().children.length > 0);
  });
  legacy_pre_effect(
    () => (deep_read_state(toggled()), get(account)),
    () => {
      set(isToggled, toggled().has(get(account)));
    }
  );
  legacy_pre_effect(
    () => (deep_read_state(selectedAccount()), get(account)),
    () => {
      set(selected, selectedAccount() === get(account));
    }
  );
  legacy_pre_effect_reset();
  init();
  ...
  var node_1 = first_child(fragment);
  {
    var consequent_2 = ($$anchor2) => {
      ...
      template_effect(() => {
        ...
        set_text(text_1, get(leafName));
      });
      event("click", button_1, select);
  ...
  var node_4 = sibling(node_1, 2);
  {
    ...
    if_block(node_4, ($$render) => {
      if (get(hasChildren) && !get(isToggled)) $$render(consequent_3);
    });
  }
  append($$anchor, fragment);
  pop();
...
function DocumentMoveModal($$anchor, $$props) {
  ...
  function onKeydown(event2) {
    if (event2.key === "Escape" && moving() && !get(saving)) onClose()();
  }
  async function submit(event2) {
    event2.preventDefault();
    if (!moving() || get(saving)) return;
    set(saving, true);
    set(error, "");
    try {
      ...
      set(error, value instanceof Error ? value.message : "Moving the document failed.");
      set(saving, false);
    }
  }
  legacy_pre_effect(() => deep_read_state(moving()), () => {
    if (moving()) {
      set(account, moving().account);
      set(newName, moving().newName);
      set(error, "");
      set(saving, false);
    }
  });
  ...
  var node = first_child(fragment);
  {
    var consequent_1 = ($$anchor2) => {
      var div = root_125();
      var form = child(div);
      template_effect(() => set_attribute(form, "aria-label", t("moveDocument")));
      var h3 = child(form);
      var text2 = child(h3, true);
      template_effect(() => set_text(text2, t("moveDocument")));
      reset(h3);
      var p = sibling(h3, 2);
      var code = child(p);
      ...
      template_effect(() => set_text(text_3, t("move")));
      reset(button);
      reset(div_1);
      ...
      each(datalist, 5, accounts, (name) => name, ($$anchor3, name) => {
        ...
        var option_value = {};
        template_effect(() => {
          if (option_value !== (option_value = get(name))) {
            option.value = null == (option.__value = get(name)) ? "" : get(name);
          }
        });
      ...
      reset(div);
      template_effect(() => {
        set_text(text_1, moving().filename);
        button.disabled = get(saving);
      });
      bind_value(input, () => get(account), ($$value) => set(account, $$value));
      bind_value(input_1, () => get(newName), ($$value) => set(newName, $$value));
      event("click", form, stopPropagation(function($$arg) {
        bubble_event.call(this, $$props, $$arg);
      }));
      event("submit", form, submit);
      event("click", div, () => !get(saving) && onClose()());
      append($$anchor2, div);
    };
    if_block(node, ($$render) => {
      if (moving()) $$render(consequent_1);
    });
  }
  append($$anchor, fragment);
  pop();
...
var root_126 = template(`<object class="svelte-1jfq29f"></object>`);
var root_48 = template(`<p class="error"> </p>`);
...
function DocumentPreview($$anchor, $$props) {
  ...
  function segment(text3) {
    return text3.split("/").map(encodeURIComponent).join("/");
  }
  let text2 = mutable_state(null);
  let textError = mutable_state(null);
  async function loadText(target2) {
    try {
      const response = await fetch(target2);
      if (!response.ok) throw new Error(`${response.status} ${response.statusText}`);
      set(text2, await response.text());
    } catch (value) {
      set(textError, value instanceof Error ? value.message : String(value));
    }
  }
  legacy_pre_effect(() => deep_read_state(filename()), () => {
    set(extension, (filename().split(".").pop() ?? "").toLowerCase());
  });
  legacy_pre_effect(() => deep_read_state(filename()), () => {
    set(url, `/documents/${segment(filename())}`);
  });
  legacy_pre_effect(() => (get(extension), get(url)), () => {
    if (plainTextExtensions.includes(get(extension))) {
      set(text2, null);
      set(textError, null);
      void loadText(get(url));
    }
  });
  legacy_pre_effect(
    () => (deep_read_state(filename()), get(extension)),
    () => {
      set(notice, t("previewNotImplemented").replace("%(filename)s", filename()).replace("%(extension)s", get(extension)));
    }
  );
  legacy_pre_effect_reset();
  init();
      ...
      var node_1 = first_child(fragment_1);
      {
        var consequent_3 = ($$anchor3) => {
          ...
          var node_2 = first_child(fragment_2);
          {
            ...
            var alternate_1 = ($$anchor4) => {
              ...
              var node_3 = first_child(fragment_3);
              {
                ...
                if_block(
                  node_3,
                  ($$render) => {
                    if (get(text2) != null) $$render(consequent_2);
                    else $$render(alternate, false);
                  },
                  true
                );
            ...
            if_block(node_2, ($$render) => {
              if (get(textError)) $$render(consequent_1);
              else $$render(alternate_1, false);
            });
          }
          append($$anchor3, fragment_2);
        ...
        var alternate_4 = ($$anchor3) => {
          ...
          var node_4 = first_child(fragment_4);
          {
            ...
            var alternate_3 = ($$anchor4) => {
              ...
              var node_5 = first_child(fragment_5);
              {
                ...
                var alternate_2 = ($$anchor5) => {
                  ...
                  reset(p_2);
                  template_effect(() => set_text(text_3, get(notice)));
                  append($$anchor5, p_2);
                };
                if_block(
                  node_5,
                  ($$render) => {
                    if (get(extension) === "html" || get(extension) === "htm") $$render(consequent_5);
                    else $$render(alternate_2, false);
                  },
                  true
                );
            ...
            if_block(
              node_4,
              ($$render) => {
                if (imageExtensions.includes(get(extension))) $$render(consequent_4);
                else $$render(alternate_3, false);
              },
              true
            );
        ...
        if_block(
          node_1,
          ($$render) => {
            if (plainTextExtensions.includes(get(extension))) $$render(consequent_3);
            else $$render(alternate_4, false);
          },
          true
        );
...
var root_220 = template(`<tr class="svelte-16svwjo"><td> </td><td> </td><td draggable="true"> </td></tr>`);
var root13 = template(`<table class="documents-table svelte-16svwjo"><thead><tr></tr></thead><tbody class="svelte-16svwjo"></tbody></table>`);
function DocumentTable($$anchor, $$props) {
  ...
  legacy_pre_effect(() => (DateColumn, StringColumn), () => {
    set(columns, [
      new DateColumn(t("date")),
      new StringColumn(t("account"), (doc) => doc.account),
      new StringColumn(t("name"), displayName)
    ]);
  });
  legacy_pre_effect(() => (Sorter, get(columns)), () => {
    set(sorter, new Sorter(get(columns)[0], "desc"));
  ...
  legacy_pre_effect(
    ...
    () => {
      set(sorted, get(sorter).sort(documents()));
    }
  );
  legacy_pre_effect_reset();
  init();
  ...
  reset(thead);
  var tbody = sibling(thead);
  each(tbody, 5, () => get(sorted), (doc) => doc.filename, ($$anchor2, doc) => {
    var tr_1 = root_220();
    var td = child(tr_1);
    var text2 = child(td, true);
    reset(td);
    ...
    template_effect(() => set_text(text_2, displayName(get(doc))));
    reset(td_2);
    reset(tr_1);
    template_effect(() => {
      set_attribute(tr_1, "title", get(doc).filename);
      toggle_class(tr_1, "selected", selected() === get(doc) || selected() != null && selected().filename === get(doc).filename);
      set_text(text2, get(doc).date);
      set_text(text_1, get(doc).account);
    });
    event("dragstart", td_2, (event2) => {
      event2.dataTransfer?.setData("fava/filename", get(doc).filename);
      if (event2.dataTransfer) event2.dataTransfer.effectAllowed = "move";
    });
    event("click", tr_1, () => onSelect()(get(doc)));
    append($$anchor2, tr_1);
  });
  reset(tbody);
  reset(table);
...
var root_49 = template(`<div class="preview"><!></div>`);
var root_221 = template(`<div class="documents-layout svelte-10uk1r4"><div class="accounts"></div> <div><!></div> <!></div>`);
...
function DocumentsReport($$anchor, $$props) {
  ...
  function buildTree(rows) {
    ...
    const root21 = { name: "", count: 0, children: [] };
    const map = /* @__PURE__ */ new Map([["", root21]]);
    const addNode = (name) => {
  ...
  function onKeyup(event2) {
    if (event2.key === "F2" && get(selected) && !get(moving)) {
      set(moving, {
  ...
  function onStartMove(detail) {
    set(moving, {
      ...detail,
      newName: basename(detail.filename)
    });
  }
  ...
  function onMoved(message) {
    notify(message);
    set(selected, null);
    void refresh();
  }
  legacy_pre_effect(() => deep_read_state(report()), () => {
    set(documents, report().rows.map((row) => ({
      date: typeof row.date === "string" ? row.date : "",
      account: typeof row.account === "string" ? row.account : "",
      filename: typeof row.filename === "string" ? row.filename : ""
    })));
  });
  legacy_pre_effect(() => get(documents), () => {
    set(tree, buildTree(get(documents)));
  });
  legacy_pre_effect(
    () => (get(accountFilter), get(documents)),
    () => {
      set(visible, get(accountFilter) ? get(documents).filter((doc) => doc.account === get(accountFilter) || doc.account.startsWith(`${get(accountFilter)}:`)) : get(documents));
    }
  );
  legacy_pre_effect_reset();
  init();
    ...
    var consequent_1 = ($$anchor2) => {
      ...
      each(div_1, 5, () => get(tree).children, (child2) => child2.name, ($$anchor3, child2) => {
        DocumentAccounts($$anchor3, {
          ...
          $$events: {
            select: (event2) => onSelectAccount(event2.detail),
            move: (event2) => onStartMove(event2.detail)
          },
          $$legacy: true
        });
      });
      ...
      reset(div);
      template_effect(() => toggle_class(div, "with-preview", get(selected) != null));
      append($$anchor2, div);
    };
    var alternate = ($$anchor2) => {
      var p = root_56();
      var text2 = child(p, true);
      template_effect(() => set_text(text2, t("noDocuments")));
      reset(p);
      append($$anchor2, p);
    };
    if_block(node_2, ($$render) => {
      if (get(documents).length) $$render(consequent_1);
      else $$render(alternate, false);
    });
  }
  append($$anchor, fragment);
...
var root_224 = template(`<span aria-hidden="true"> </span>`);
var on_click_12 = (__1, toggleSort) => toggleSort("line");
var root_315 = template(`<span aria-hidden="true"> </span>`);
var on_click_22 = (__2, toggleSort) => toggleSort("message");
var root_410 = template(`<span aria-hidden="true"> </span>`);
...
var root_225 = ns_template(`<line class="chart-grid svelte-8kp6hz"></line><text class="chart-tick svelte-8kp6hz" text-anchor="end"> </text>`, 1);
var root_316 = ns_template(`<text y="51" class="chart-tick svelte-8kp6hz" text-anchor="middle"> </text>`);
var root_411 = ns_template(`<circle r="1.3" class="svelte-8kp6hz"></circle>`);
var root_130 = template(`<svg class="scatter-chart svelte-8kp6hz" viewBox="0 0 100 52" role="img" aria-label="Events scatterplot"><!><!><!></svg>`);
var root_58 = template(`<p class="chart-empty svelte-8kp6hz">No events.</p>`);
var root_68 = template(`<div class="chart-tooltip svelte-8kp6hz" role="status"> </div>`);
var root14 = template(`<section class="scatter-card svelte-8kp6hz"><!> <!></section>`);
function ScatterPlot($$anchor, $$props) {
  push($$props, false);
  const data = mutable_state();
  const types = mutable_state();
  const extent = mutable_state();
  const today = mutable_state();
  ...
  function y(type) {
    const index2 = get(types).indexOf(type);
    const count = get(types).length;
    if (!count) return Y0;
...
${best.date}`);
  ...
  legacy_pre_effect(() => deep_read_state(events()), () => {
    set(data, events().map((event2) => ({
      timestamp: Date.parse(event2.date),
      date: event2.date,
      type: event2.type,
      description: event2.description
    })).filter((datum) => Number.isFinite(datum.timestamp)));
  });
  legacy_pre_effect(() => get(data), () => {
    set(types, [
      ...new Set(get(data).map((datum) => datum.type))
    ]);
  });
  legacy_pre_effect(() => get(data), () => {
    set(extent, get(data).length ? [
      Math.min(...get(data).map((datum) => datum.timestamp)),
      Math.max(...get(data).map((datum) => datum.timestamp))
    ] : [0, 1]);
  });
  legacy_pre_effect(() => {
  }, () => {
    set(today, (/* @__PURE__ */ new Date()).toISOString().slice(0, 10));
  });
  legacy_pre_effect(() => (get(data), get(extent)), () => {
    set(xTicks, (() => {
      if (!get(data).length) return [];
      const count = Math.min(5, get(data).length);
      const ticks = [];
      for (let stop = 0; stop < count; stop += 1) {
        const timestamp = get(extent)[0] + (get(extent)[1] - get(extent)[0]) * stop / Math.max(1, count - 1);
  ...
  var node = child(section);
  {
    var consequent = ($$anchor2) => {
      ...
      each(node_1, 1, () => get(types), (type) => type, ($$anchor3, type) => {
...
var root_226 = template(`<tr><td> </td><td> </td></tr>`);
var root15 = template(`<table class="events-table svelte-1nok83z"><thead><tr></tr></thead><tbody></tbody></table>`);
function EventTable($$anchor, $$props) {
  ...
  legacy_pre_effect(() => (DateColumn, StringColumn), () => {
    set(columns, [
      new DateColumn(t("date")),
      new StringColumn(t("description"), (event2) => event2.description)
    ]);
  });
  legacy_pre_effect(() => (Sorter, get(columns)), () => {
    set(sorter, new Sorter(get(columns)[0], "desc"));
  ...
  legacy_pre_effect(
    ...
    () => {
      set(sorted, get(sorter).sort(events()));
    }
  );
  legacy_pre_effect_reset();
  init();
...
var root_227 = template(`<!> <div class="chart-switcher svelte-1cxn66i"><button type="button" class="unset selected svelte-1cxn66i"> </button></div>`, 1);
var root_317 = template(`<div class="left"><h3> </h3> <!></div>`);
var root_131 = template(`<div class="flex-row svelte-1cxn66i"><span class="spacer svelte-1cxn66i"></span> <button type="button" class="show-charts"> </button></div> <!> <!>`, 1);
var root_412 = template(`<p> </p>`);
function EventsReport($$anchor, $$props) {
  ...
  legacy_pre_effect(() => deep_read_state(report()), () => {
    set(chartEvents, report().rows.map((row) => ({
      date: typeof row.date === "string" ? row.date : "",
  ...
  var node = first_child(fragment);
  {
    var consequent_1 = ($$anchor2) => {
      ...
      {
        var consequent = ($$anchor3) => {
          var fragment_2 = root_227();
          var node_2 = first_child(fragment_2);
          ScatterPlot(node_2, {
            get events() {
              return get(chartEvents);
            }
          });
          var div_1 = sibling(node_2, 2);
          var button_1 = child(div_1);
          var text_1 = child(button_1, true);
          template_effect(() => set_text(text_1, t("events")));
          reset(button_1);
          reset(div_1);
          append($$anchor3, fragment_2);
        };
        if_block(node_1, ($$render) => {
          if (get(showCharts)) $$render(consequent);
        });
      }
      ...
      each(node_3, 1, () => get(groups), ([type, events]) => type, ($$anchor3, $$item) => {
        ...
        var h3 = child(div_2);
        var text_2 = child(h3);
        template_effect(() => set_text(text_2, `${t("eventHeading") ?? ""} ${type() ?? ""}`));
        reset(h3);
      ...
      template_effect(() => set_text(text2, get(showCharts) ? "\u25BC" : "\u25C0"));
      event("click", button, () => set(showCharts, !get(showCharts)));
      append($$anchor2, fragment_1);
    };
    var alternate = ($$anchor2) => {
      var p = root_412();
    ...
    if_block(node, ($$render) => {
      if (get(groups).length) $$render(consequent_1);
      else $$render(alternate, false);
    });
  }
  append($$anchor, fragment);
...
var root_133 = template(`<button type="button" class="unset expander svelte-xjp7mv"> </button>`);
var root_228 = template(`<span class="num svelte-xjp7mv"> </span>`);
var root_413 = template(`<span class="other-line svelte-xjp7mv"> </span>`);
var root_318 = template(`<span class="other num svelte-xjp7mv"></span>`);
var root_59 = template(`<ol></ol>`);
var root16 = template(`<li><p><span class="account-cell svelte-xjp7mv"><!> <a class="account svelte-xjp7mv"> </a></span> <!> <!></p> <!></li>`);
...
var root_134 = template(`<span class="num"> </span>`);
var root_229 = template(`<span class="other">Other</span>`);
var root17 = template(`<ol class="flex-table tree-table-new" data-tree-table=""><li class="head"><p><span class="account-cell svelte-1xyup19"> </span> <!> <!></p></li> <!></ol>`);
...
var root_319 = template(`<button type="button" class="unset svelte-1dzjfb9"> </button>`);
var root_230 = template(`<nav class="chart-picker svelte-1dzjfb9"></nav>`);
var root_135 = template(`<div class="report-charts"><!> <!></div>`);
var root18 = template(`<!> <div class="row"><div class="column"></div> <div class="column"></div></div>`, 1);
...
var root_136 = template(`<section class="state-panel" role="status">Loading\u2026</section>`);
var root_320 = template(`<section class="state-panel error-panel" role="alert"> </section>`);
var root_510 = template(`<div class="headerline"><h2> </h2></div> <p><a href="/help"> </a></p> <div class="help-body svelte-1hd97ci"> </div>`, 1);
var root_86 = template(`<li><a> </a></li>`);
var root_76 = template(`<div class="headerline"><h2>Help</h2></div> <ul class="help-index svelte-1hd97ci"></ul>`, 1);
var root_104 = template(`<div class="headerline"><h2> </h2></div> <pre class="source-content svelte-1hd97ci"> </pre>`, 1);
var root_137 = template(`<li><a> </a></li>`);
var root_1210 = template(`<div class="headerline"><h2>Source files</h2></div> <ul class="source-list svelte-1hd97ci"></ul>`, 1);
var root_162 = template(`<label class="button svelte-1hd97ci"><input type="radio" name="color-scheme" class="svelte-1hd97ci"> </label>`);
var root_182 = template(`<select id="fava-option-locale"><option>English</option><option>\u7B80\u4F53\u4E2D\u6587</option></select>`);
...
var root_202 = template(`<tr><td class="svelte-1hd97ci"> </td><td class="svelte-1hd97ci"><pre class="svelte-1hd97ci"> </pre></td></tr>`);
...
function UtilityReport($$anchor, $$props) {
  ...
  const favaRows = mutable_state();
  const beancountRows = mutable_state();
  const optionColumns = mutable_state();
  const favaSorter = mutable_state();
  const beancountSorter = mutable_state();
  const sortedFavaRows = mutable_state();
  const sortedBeancountRows = mutable_state();
  const helpSections = mutable_state();
  const activeHelpSection = mutable_state();
  let adapter = prop($$props, "adapter", 8);
  let route = prop($$props, "route", 8);
  ...
  legacy_pre_effect(
    () => (get(data), deep_read_state(locale()), deep_read_state(theme())),
    () => {
      set(favaRows, (() => {
  ...
  legacy_pre_effect(() => get(data), () => {
    set(beancountRows, objectEntries(get(data)?.options).map(([key, value]) => [key, String(value)]).sort(([a], [b]) => a.localeCompare(b)));
  });
  legacy_pre_effect(() => StringColumn, () => {
    set(optionColumns, [
      new StringColumn(t("optionKey"), (row) => row[0]),
      new StringColumn(t("optionValue"), (row) => row[1])
    ]);
  });
  legacy_pre_effect(() => (Sorter, get(optionColumns)), () => {
    set(favaSorter, new Sorter(get(optionColumns)[0], "asc"));
  });
  legacy_pre_effect(() => (Sorter, get(optionColumns)), () => {
    set(beancountSorter, new Sorter(get(optionColumns)[0], "asc"));
  });
  legacy_pre_effect(() => (get(favaSorter), get(favaRows)), () => {
    set(sortedFavaRows, get(favaSorter).sort(get(favaRows)));
  });
  legacy_pre_effect(
    () => (get(beancountSorter), get(beancountRows)),
    () => {
      set(sortedBeancountRows, get(beancountSorter).sort(get(beancountRows)));
    }
  );
  legacy_pre_effect(() => get(data), () => {
    set(helpSections, Array.isArray(get(data)?.sections) ? get(data).sections : []);
  });
  legacy_pre_effect(
    () => (get(helpSections), deep_read_state(helpPage())),
    () => {
      set(activeHelpSection, get(helpSections).find((section) => section.id === helpPage()));
    }
  );
  legacy_pre_effect_reset();
  init();
        ...
        var alternate_6 = ($$anchor3) => {
          ...
          var node_2 = first_child(fragment_2);
          {
            var consequent_2 = ($$anchor4) => {
              ...
              template_effect(() => set_text(text_2, `\u2039 ${t("help") ?? ""}`));
              reset(a_1);
              reset(p);
              ...
              reset(div_1);
              template_effect(() => {
                set_text(text_1, get(activeHelpSection).title);
                set_text(text_3, get(activeHelpSection).body);
              });
              append($$anchor4, fragment_3);
            };
            var alternate_5 = ($$anchor4) => {
              ...
              {
                var consequent_3 = ($$anchor5) => {
                  var fragment_5 = root_76();
                  var ul = sibling(first_child(fragment_5), 2);
                  each(ul, 5, () => get(helpSections), (section) => section.id, ($$anchor6, section) => {
                    var li = root_86();
                    var a_2 = child(li);
                    template_effect(() => set_attribute(a_2, "href", `/help/${encodeURIComponent(get(section).id)}`));
                    var text_4 = child(a_2, true);
                    reset(a_2);
                    reset(li);
                    template_effect(() => set_text(text_4, get(section).title));
                    append($$anchor6, li);
                  });
                  reset(ul);
                ...
                var alternate_4 = ($$anchor5) => {
                  ...
                  var node_4 = first_child(fragment_6);
                  {
                    var consequent_4 = ($$anchor6) => {
                      ...
                      reset(pre);
                      template_effect(() => {
                        set_text(text_5, get(data).path);
                        set_text(text_6, get(data).content);
                      });
                    ...
                    var alternate_3 = ($$anchor6) => {
                      ...
                      var node_5 = first_child(fragment_8);
                      {
                        ...
                        var alternate_2 = ($$anchor7) => {
                          ...
                          var node_6 = first_child(fragment_10);
                          {
                            var consequent_7 = ($$anchor8) => {
                              ...
                              template_effect(() => set_text(text_8, t("options")));
                              reset(h2_2);
                              reset(div_3);
                              var h3 = sibling(div_3, 2);
                              var text_9 = child(h3, true);
                              template_effect(() => set_text(text_9, t("colorScheme")));
                              reset(h3);
                              var p_1 = sibling(h3, 2);
                              var span = child(p_1);
                              template_effect(() => set_attribute(span, "aria-label", t("colorScheme")));
                              each(span, 5, () => get(colorSchemes), ([value, label]) => value, ($$anchor9, $$item) => {
                                ...
                                reset(label_1);
                                template_effect(() => {
                                  toggle_class(label_1, "muted", theme() !== value());
                                  set_value(input, value());
                                  set_checked(input, theme() === value());
                                  set_text(text_10, ` ${label() ?? ""}`);
                                });
                                event("change", input, () => onTheme()(value()));
                                append($$anchor9, label_1);
                              });
                              reset(span);
                              reset(p_1);
                              var h3_1 = sibling(p_1, 2);
                              var text_11 = child(h3_1);
                              template_effect(() => set_text(text_11, `${t("favaOptions") ?? ""} `));
                              var a_4 = sibling(text_11);
                              var text_12 = child(a_4);
                              template_effect(() => set_text(text_12, `(${t("help") ?? ""})`));
                              reset(a_4);
                              reset(h3_1);
                              var table = sibling(h3_1, 2);
                              var thead = child(table);
                              ...
                              SortHeader(node_7, {
                                get column() {
                                  return get(optionColumns)[0];
                                },
                                get sorter() {
                                  return get(favaSorter);
                                },
                                set sorter($$value) {
                                  set(favaSorter, $$value);
                                },
                                $$legacy: true
                              });
                              ...
                              each(tbody, 5, () => get(sortedFavaRows), ([key, value]) => key, ($$anchor9, $$item) => {
                                ...
                                var node_9 = child(td_1);
                                {
                                  var consequent_6 = ($$anchor10) => {
                                    ...
                                    append($$anchor10, select);
                                  };
                                  var alternate = ($$anchor10) => {
                                    var pre_1 = root_193();
                                    var text_14 = child(pre_1, true);
                                    reset(pre_1);
                                    template_effect(() => set_text(text_14, value()));
                                    append($$anchor10, pre_1);
                                  };
                                  if_block(node_9, ($$render) => {
                                    if (key() === "locale") $$render(consequent_6);
                                    else $$render(alternate, false);
                                  });
                                }
                                reset(td_1);
                                reset(tr_1);
                                template_effect(() => set_text(text_13, key()));
                                append($$anchor9, tr_1);
                              });
                              reset(tbody);
                              reset(table);
                              ...
                              template_effect(() => set_text(text_15, t("beancountOptions")));
                              reset(h3_2);
                              var table_1 = sibling(h3_2, 2);
                              var thead_1 = child(table_1);
                              var tr_2 = child(thead_1);
                              var node_10 = child(tr_2);
                              SortHeader(node_10, {
                                get column() {
                                  return get(optionColumns)[0];
                                },
                                get sorter() {
                                  return get(beancountSorter);
                                },
                                set sorter($$value) {
                                  set(beancountSorter, $$value);
                                },
                                $$legacy: true
                              });
                              ...
                              each(tbody_1, 5, () => get(sortedBeancountRows), ([key, value]) => key, ($$anchor9, $$item) => {
                                ...
                                reset(td_2);
                                var td_3 = sibling(td_2);
                                var pre_2 = child(td_3);
                                var text_17 = child(pre_2, true);
                                reset(pre_2);
                                reset(td_3);
                                reset(tr_3);
                                template_effect(() => {
                                  set_text(text_16, key());
                                  set_text(text_17, value());
                                });
                                append($$anchor9, tr_3);
                              });
                              reset(tbody_1);
                            ...
                            var alternate_1 = ($$anchor8) => {
                              ...
                              reset(h2_3);
                              reset(div_4);
                              var pre_3 = sibling(div_4, 2);
                              var text_19 = child(pre_3, true);
                              template_effect(() => set_text(text_19, JSON.stringify(get(data), null, 2)));
                              reset(pre_3);
                              template_effect(() => set_text(text_18, route()));
                              append($$anchor8, fragment_12);
                            };
                            if_block(
                              node_6,
                              ($$render) => {
                                if (route() === "options") $$render(consequent_7);
                                else $$render(alternate_1, false);
                              },
                              true
                            );
                        ...
                        if_block(
                          node_5,
                          ($$render) => {
                            if (route() === "source" && get(data)?.paths) $$render(consequent_5);
                            else $$render(alternate_2, false);
                          },
                          true
                        );
                    ...
                    if_block(
                      node_4,
                      ($$render) => {
                        if (route() === "source" && get(data)?.content !== void 0) $$render(consequent_4);
                        else $$render(alternate_3, false);
                      },
                      true
                    );
                ...
                if_block(
                  node_3,
                  ($$render) => {
                    if (route() === "help" && get(data)?.sections) $$render(consequent_3);
                    else $$render(alternate_4, false);
                  },
                  true
                );
            ...
            if_block(
              node_2,
              ($$render) => {
                if (route() === "help" && get(activeHelpSection)) $$render(consequent_2);
                else $$render(alternate_5, false);
              },
              true
            );
...
var root_138 = template(`<section class="state-panel" role="status" aria-live="polite">Loading report\u2026</section>`);
var root_321 = template(`<section class="state-panel error-panel" role="alert"> </section>`);
...
function ReportOutlet($$anchor, $$props) {
  ...
  let journal = mutable_state(null);
  let statistics = mutable_state(null);
  async function load(key) {
    set(loading, true);
    set(error, null);
    set(report, null);
    ...
    try {
      ...
      if ([
        ...
        const composite = payload;
        const entriesByType = Object.entries(composite.entries_by_type ?? {}).sort(([left], [right]) => left.localeCompare(right));
        set(statistics, {
          entriesByType,
          postings: parseTableReport(composite.postings_per_account),
          updateActivity: composite.update_activity ?? []
        });
      } else {
...
var root_139 = template(`<div class="overlay svelte-e0j49v" aria-hidden="true"></div>`);
var root_323 = template(`<li class="navigation-heading svelte-e0j49v" aria-hidden="true"> </li>`);
var on_click5 = (event2, onNavigate, item) => {
  event2.preventDefault();
  onNavigate()(routeHref(get(item)));
};
var root_69 = template(`<a href="#export" class="secondary svelte-e0j49v">&#11015;</a>`);
var on_click_13 = (event2, onNavigate, saved) => {
  event2.preventDefault();
  onNavigate()(`/query?query_string=${encodeURIComponent(get(saved).query_string)}`);
};
var root_87 = template(`<li class="svelte-e0j49v"><a class="svelte-e0j49v"> </a></li>`);
var root_77 = template(`<ul class="submenu svelte-e0j49v"></ul>`);
var root_511 = template(`<li class="svelte-e0j49v"><a class="svelte-e0j49v"> </a> <!> <!></li>`);
...
var root_234 = template(`<p class="error svelte-1eapejs" role="alert"> </p>`);
var root_512 = template(`<a class="svelte-1eapejs"> </a>`);
var root_611 = template(`<span class="span svelte-1eapejs"> </span>`);
var root_415 = template(`<p class="location svelte-1eapejs"><!> <!></p> <p class="summary svelte-1eapejs"> <!> <!> <!> <!></p> <pre class="source svelte-1eapejs"> </pre>`, 1);
var root_1111 = template(`<p class="loading svelte-1eapejs"> </p>`);
var root_141 = template(`<div class="context-backdrop svelte-1eapejs" role="presentation"><div class="context-modal svelte-1eapejs" role="dialog" aria-modal="true"><h3 class="svelte-1eapejs"> </h3> <!></div></div>`);
function ContextModal($$anchor, $$props) {
  ...
  function sync() {
    ...
    const next2 = hash2.startsWith("#context-") ? hash2.slice("#context-".length) : "";
    if (next2 !== entryHash) {
      entryHash = next2;
      set(context, null);
      set(error, "");
  ...
  async function load() {
    try {
      set(context, await adapter().load("entry-context", { entry_hash: entryHash }));
    } catch (value) {
      set(error, value instanceof Error ? value.message : "The entry context could not be loaded.");
    }
  }
  function close() {
    window.history.replaceState({}, "", window.location.pathname + window.location.search);
  ...
  var node = first_child(fragment);
  {
    var consequent_8 = ($$anchor2) => {
      ...
      var h3 = child(div_1);
      var text2 = child(h3, true);
      template_effect(() => set_text(text2, t("context")));
      reset(h3);
      var node_1 = sibling(h3, 2);
      {
        var consequent = ($$anchor3) => {
        ...
        var alternate_1 = ($$anchor3) => {
          ...
          var node_2 = first_child(fragment_1);
          {
            var consequent_7 = ($$anchor4) => {
              ...
              var node_3 = child(p_1);
              {
                var consequent_1 = ($$anchor5) => {
                  ...
                  reset(a);
                  template_effect(() => set_text(text_2, get(context).entry.file));
                  append($$anchor5, a);
                };
                if_block(node_3, ($$render) => {
                  if (get(context).entry.file) $$render(consequent_1);
                });
              }
              var node_4 = sibling(node_3, 2);
              {
                ...
                if_block(node_4, ($$render) => {
                  if (get(context).entry.span) $$render(consequent_2);
                });
              }
              reset(p_1);
              ...
              var node_5 = sibling(text_4);
              {
                var consequent_3 = ($$anchor5) => {
                  var text_5 = text();
                  template_effect(() => set_text(text_5, get(context).entry.flag));
                  append($$anchor5, text_5);
                };
                if_block(node_5, ($$render) => {
                  if (get(context).entry.flag) $$render(consequent_3);
                });
              }
              var node_6 = sibling(node_5, 2);
              {
                var consequent_4 = ($$anchor5) => {
                  var text_6 = text();
                  template_effect(() => set_text(text_6, get(context).entry.payee));
                  append($$anchor5, text_6);
                };
                if_block(node_6, ($$render) => {
                  if (get(context).entry.payee) $$render(consequent_4);
                });
              }
              var node_7 = sibling(node_6, 2);
              {
                var consequent_5 = ($$anchor5) => {
                  var text_7 = text();
                  template_effect(() => set_text(text_7, `"${get(context).entry.narration ?? ""}"`));
                  append($$anchor5, text_7);
                };
                if_block(node_7, ($$render) => {
                  if (get(context).entry.narration) $$render(consequent_5);
                });
              }
              var node_8 = sibling(node_7, 2);
              {
                var consequent_6 = ($$anchor5) => {
                  var text_8 = text();
                  template_effect(() => set_text(text_8, get(context).entry.account));
                  append($$anchor5, text_8);
                };
                if_block(node_8, ($$render) => {
                  if (get(context).entry.account) $$render(consequent_6);
                });
              }
              reset(p_2);
            ...
            var alternate = ($$anchor4) => {
              ...
              template_effect(() => set_text(text_10, t("loading")));
              reset(p_3);
              append($$anchor4, p_3);
            };
            if_block(
...
var root_325 = template(`<p class="error svelte-bpl3hy" role="alert"> </p>`);
var root_513 = template(`<input class="file svelte-bpl3hy" type="text">`);
var root_79 = template(`<option> </option>`);
var root_612 = template(`<div class="field svelte-bpl3hy"><span class="svelte-bpl3hy"> </span> <select class="svelte-bpl3hy"></select></div>`);
    ...
    var consequent_3 = ($$anchor2) => {
      ...
      var node_4 = sibling(node_2, 2);
      {
        var consequent_2 = ($$anchor3) => {
          ...
          each(select, 5, documentRoots, (root21) => root21, ($$anchor4, root21) => {
            var option = root_79();
            var option_value = {};
            var text_4 = child(option, true);
            reset(option);
            template_effect(() => {
              if (option_value !== (option_value = get(root21))) {
                option.value = null == (option.__value = get(root21)) ? "" : get(root21);
              }
              set_text(text_4, get(root21));
            });
...
var root_143 = template(`<div class="export-backdrop svelte-gn9rfu" role="presentation"><div class="export-modal svelte-gn9rfu" role="dialog" aria-modal="true"><h3 class="svelte-gn9rfu"> </h3> <a download="journal.bean" class="svelte-gn9rfu"> </a></div></div>`);
...
function reduceShellState(state2, action2) {
  switch (action2.type) {
    case "route":
      return { ...state2, route: action2.route, helpPage: action2.helpPage || "", query: action2.query || {}, sidebarOpen: false, error: null };
    case "locale":
...
// src/fava/App.svelte
var root_144 = template(`<meta name="description" content="OrangeCount local ledger interface">`);
var root20 = template(`<!> <!> <article id="main-content" tabindex="-1"><!></article> <!> <!> <!> <!>`, 1);

...
var favaAdapterWritePaths = map[string]bool{
	...
	"planning-preview":          true,
	"planning-commit":           true,
	"planning-scenario":         true,
	"planning-review-preview":   true,
	"planning-generate-preview": true,
}
...
var favaAdapterRoutes = map[string]favaHandler{
	...
	"planning":                  (*Server).handlePlanning,
	"planning-review":           (*Server).handlePlanningReview,
	"planning-scenario":         (*Server).handlePlanningScenario,
	"planning-review-preview":   (*Server).handlePlanningReviewPreview,
	"planning-generate-preview": (*Server).handlePlanningGeneratePreview,
	"planning-preview":          (*Server).handlePlanningPreview,
	"planning-commit":           (*Server).handlePlanningCommit,

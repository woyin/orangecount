  ...
  switch (action.type) {
    ...
    case "bootstrap":
      return {
        ...
        userQueries: Array.isArray(action.userQueries) ? action.userQueries : state.userQueries,
        documentRoots: Array.isArray(action.documentRoots) ? action.documentRoots : state.documentRoots,
        ...
        accountDetails: action.accountDetails && typeof action.accountDetails === "object" ? action.accountDetails : state.accountDetails,

...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    moveDocument: "Move or rename document", move: "Move",
    ...
    fixFirst: "Fix first", recheckAfter: "Recheck after source fixes", repairOrderHint: "Fix source and syntax problems first, then run validation again before reviewing accounting diagnostics.",
    ...
    updateActivity: "Update Activity", updateActivityLastEntry: "Last Entry",
   treemap: "Treemap", icicle: "Icicle", sunburst: "Sunburst",
   stackedBars: "Stacked Bars", singleBars: "Single Bars", lineChart: "Line chart", areaChart: "Area chart",
   export: "Export", downloadFilteredEntries: "Download currently filtered entries as a Beancount file",
    context: "Context",
    add: "Add", transaction: "Transaction", balance: "Balance", note: "Note",
    amount: "Amount", comment: "Comment", continueAdding: "continue", entryAdded: "Entry added.",
    accountBalance: "Balance", changes: "Changes", balances: "Balances", monthly: "monthly", quarterly: "quarterly", yearly: "yearly",
    currentAverageCost: "Current average cost", averageCostEvolution: "Average cost evolution", costPerUnit: "cost per unit",
    uploadFiles: "Upload file(s)", documentsFolder: "Documents folder", upload: "Upload",
    ...
    reload: "Reload",
    quickEntry: "Quick",
    quickEntryPlaceholder: "午餐 28 @微信\n或: 28 CNY @source -> @dest : narration",
    quickEntryHint: "Ctrl+Enter to preview, then Ctrl+Enter again to commit",
    quickEntryPublished: "Quick entry published.",
    quickEntryUndone: "Quick entry batch undone.",
    quickEntryUndo: "Undo last batch",
    quickEntryDuplicate: "A similar transaction already exists in the ledger",
    quickProfileTitle: "Quick Entry Profile",
    quickProfileAccount: "Account alias",
    quickProfileTemplate: "Template",
    quickProfileName: "Name",
    quickProfileAdd: "Add profile rule",
    quickProfileType: "Type",
    planning: "Planning", planningSetup: "Planning setup required", safeToSpend: "Safe to spend", lowPoint: "Lowest point", fundingShortfall: "Funding shortfall", planningStale: "Recorded-through date is not today; this is a stale estimate.", purchaseScenario: "Test a large purchase", purchaseName: "Proposed purchase", includeInflows: "Include future inflows", releaseAdjustable: "Release adjustable outflows", evaluate: "Evaluate", scenarioLowPoint: "Scenario low point", scenarioEphemeral: "This trial is not saved to the ledger.", committed: "Committed", adjustable: "Adjustable", inflows: "Future inflows", cycleReview: "Cycle review", inspectReview: "Inspect review evidence", reviewConfirmation: "Suggestions are evidence only; nothing is fulfilled automatically.", matchSuggestions: "Plan-to-actual suggestions", recurringCandidates: "Recurring candidates", occurrences: "occurrences", reviewStale: "The completed review is stale and needs reconfirmation.", reviewComplete: "This review is completed.", previewReview: "Preview review completion", commitReview: "Save reviewed completion", minimumReserve: "Minimum reserve", spendableAccounts: "Spendable accounts (comma separated)", debtAccounts: "Short-term debt accounts (comma separated)", recordedThrough: "Recorded through", addPlan: "Add a planned flow", planID: "Plan ID", direction: "Direction", outflow: "Outflow", inflow: "Inflow", commitment: "Commitment", reviewedWrite: "Review change", resolvePlan: "Resolve an active plan", resolution: "Resolution", fulfilled: "Fulfilled", cancelled: "Cancelled", reschedule: "Reschedule", useCandidate: "Use as a plan draft",
  },
  "zh-CN": {
    ...
    lastEntry: "最后条目：",
    updateActivity: "更新活动", updateActivityLastEntry: "最近条目",
   treemap: "矩形树图", icicle: "冰柱图", sunburst: "旭日图",
   stackedBars: "堆叠柱状图", singleBars: "单柱状图", lineChart: "折线图", areaChart: "面积图",
   export: "导出", downloadFilteredEntries: "将当前过滤后的条目下载为 Beancount 文件",
    context: "上下文",
    add: "新增", transaction: "交易", balance: "余额断言", note: "备注",
    amount: "金额", comment: "备注内容", continueAdding: "继续添加", entryAdded: "条目已添加。",
    accountBalance: "余额", changes: "变动", balances: "期末余额", monthly: "每月", quarterly: "每季度", yearly: "每年",
    currentAverageCost: "当前平均成本", averageCostEvolution: "平均成本演化", costPerUnit: "每单位成本",
    uploadFiles: "上传文件", documentsFolder: "文档目录", upload: "上传",
    noDocumentRoot: "未配置文档根目录；请以 serve --document-root 启动服务。",
    fileChangeDetected: "检测到文件变更。点击以重新加载。",
    reload: "重新加载",
    quickEntry: "速记",
    quickEntryPlaceholder: "午餐 28 @微信\n或: 28 CNY @source -> @dest : 摘要",
    quickEntryHint: "Ctrl+Enter 预览，再按 Ctrl+Enter 确认提交",
    quickEntryPublished: "速记条目已发布。",
    quickEntryUndone: "已撤销最近一批速记。",
    quickEntryUndo: "撤销最近一批",
    quickEntryDuplicate: "账本中已存在相似的交易",
    quickProfileTitle: "速记配置",
    quickProfileAccount: "账户别名",
    quickProfileTemplate: "模板",
    quickProfileName: "名称",
    quickProfileAdd: "添加配置规则",
    quickProfileType: "类型",
    planning: "规划", planningSetup: "需要完成规划设置", safeToSpend: "安全可支配金额", lowPoint: "资金最低点", fundingShortfall: "资金缺口", planningStale: "已记账截至日期不是今天；这是过期估算。", purchaseScenario: "试算一笔大额支出", purchaseName: "拟购项目", includeInflows: "计入未来流入", releaseAdjustable: "释放可调整流出", evaluate: "开始试算", scenarioLowPoint: "试算最低点", scenarioEphemeral: "本次试算不会写入账本。", committed: "已承诺", adjustable: "可调整", inflows: "未来流入", cycleReview: "周期复盘", inspectReview: "查看复盘证据", reviewConfirmation: "建议只提供证据，不会自动完成计划。", matchSuggestions: "计划与实际匹配建议", recurringCandidates: "周期性候选", occurrences: "笔发生记录", reviewStale: "已完成的复盘已过期，需要重新确认。", reviewComplete: "本次复盘已完成。", previewReview: "预览复盘完成记录", commitReview: "保存已审阅的完成记录", minimumReserve: "最低保留金", spendableAccounts: "可支配账户（逗号分隔）", debtAccounts: "短期债务账户（逗号分隔）", recordedThrough: "记账截至日期", addPlan: "新增计划现金流", planID: "计划 ID", direction: "方向", outflow: "流出", inflow: "流入", commitment: "承诺类型", reviewedWrite: "审阅变更", resolvePlan: "处置活动计划", resolution: "处置方式", fulfilled: "已履行", cancelled: "已取消", reschedule: "改期", useCandidate: "作为计划草稿使用",
  },
};

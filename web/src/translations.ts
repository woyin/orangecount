...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
   ...
   stackedBars: "Stacked Bars", singleBars: "Single Bars", lineChart: "Line chart", areaChart: "Area chart",
    modernChartLayer: "Modern chart layer", parityChartLayer: "Fava parity chart layer", useModernChart: "Modern", useParityChart: "Fava",
  ...
  "zh-CN": {
   ...
   stackedBars: "堆叠柱状图", singleBars: "单柱状图", lineChart: "折线图", areaChart: "面积图",
    modernChartLayer: "现代图表层", parityChartLayer: "Fava 一致性图表层", useModernChart: "现代", useParityChart: "Fava",

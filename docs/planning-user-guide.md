...
- [ADR-0047](adr/0047-embed-planning-assumptions-in-the-ledger.md)：规划数据如何放进账本。
- [ADR-0048](adr/0048-build-liquidity-planning-before-category-budgets.md)：为什么先做流动性规划，不做分类预算。
